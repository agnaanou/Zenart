...
function ajouterclient(){
    ...
    nomTd.value = localStorage.getItem(nomTd)

    $(document).ready(function () {
        window.onbeforeunload = function() {
            localStorage.setItem(nomTd, $('#inputNomTd').val());
            localStorage.setItem(prenomTd, $('#inputPrenomTd').val());
         }
    
         window.onload = function() {
            var nom = localStorage.getItem(nomTd);
            var prenom = localStorage.getItem(prenomTd);
            if (nomTd !== null) $('#inputNomTd').val(nomTd); if (prenomTd !== null) $('#inputPrenomTd').val(prenomTd);
         }
